    ...
    <div class="qna-wrapper">
      <div class="qna-container">
        ...
        <div class="board-controls">
          <RouterLink to="/free/write" class="write-btn">글 작성</RouterLink>
        </div>
        ...
        <table class="board-table">
          ...
          <tbody>
            <tr v-for="post in posts" :key="post.pid">
              <td>{{ post.pid }}</td>
              <td>
                <RouterLink :to="`/free/detail/${post.pid}`">{{ post.title }}</RouterLink>
              </td>
...
const searchType = ref('title') // 검색 유형: title 또는 user
const searchKeyword = ref('') // 검색어
const isSearching = ref(false) // 검색 중 여부
